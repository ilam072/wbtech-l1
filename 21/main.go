...
// Применимость:
// Используется, когда нужно подключить новый или сторонний сервис,
// не изменяя существующий клиентский код (легаси, внешние библиотеки).
//
// Примеры из практики:
// — замена платёжного провайдера без переписывания бизнес-логики
// — приведение SDK стороннего API к интерфейсу приложения
// — адаптация логгеров, HTTP-клиентов и тд под общий интерфейс
